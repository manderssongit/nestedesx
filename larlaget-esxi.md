# Lär-läget: nested ESXi steg för steg
...
Set-EsxiHostBaseline -HostAddress 192.168.0.51 -RootPw 'VMware1!' `
    -ShortName esx-mgmt01 -Domain nested.internal -Dns 192.168.0.10 -Ntp 192.168.0.10
```
...
- **Lär-läget** (`New-EsxiLabVM` + `Set-EsxiHostBaseline`) — för att förstå och för att andra ska kunna följa med.
